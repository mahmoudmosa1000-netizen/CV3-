...
const TRANSLATIONS = {
  ...
  de: {
    ...
    tplSidebarName:      'Seitenleiste',
    tplSingleName:       'Einspaltig',
    tplAtsName:          'ATS-kompakt',
    tplTimelineName:     'Zeitleiste',
  ...
  en: {
    ...
    // Folio
    sectionFolio:        '🎨 Digital Folio & QR Links',
    folioWhyTitle:       '✨ Why QR codes in your CV?',
    folioBenefit1Title:  'Instant access',
    folioBenefit1Desc:   'Recruiters scan with their phone — your portfolio opens in seconds, no typing needed.',
    folioBenefit2Title:  'Clickable on paper too',
    folioBenefit2Desc:   'Printed CVs stay interactive — QR codes bridge print and digital.',
    folioBenefit3Title:  'Multiple links possible',
    folioBenefit3Desc:   'Portfolio, GitHub, reference project, LinkedIn — each link gets its own QR code.',
    folioBenefit4Title:  'Professional impression',
    folioBenefit4Desc:   'Demonstrates digital skills and makes your application stand out from the crowd.',
    folioGuideTitle:     '📋 How to add links & QR codes',
    folioStep1:          'Click <strong>+ Add link</strong> below.',
    folioStep2:          'Enter the <strong>URL</strong> (e.g. https://behance.net/…).',
    folioStep3:          'Choose a <strong>link text</strong> — these are the words that appear as clickable in your CV (e.g. "My Portfolio", "GitHub Projects").',
    folioStep4:          'Enable <strong>Show as link</strong> and/or <strong>Embed QR code</strong> — both can be combined.',
    folioStep5:          'All links & QR codes appear automatically in the <strong>left sidebar</strong> of your CV.',
    folioStep6:          'Add as <strong>many links as you like</strong> — e.g. Portfolio, GitHub, reference website, YouTube demo.',
    btnAddFolioLink:     '+ Add link & QR code',
    labelFolioURL:       'URL',
    placeholderFolioURL: 'https://behance.net/...',
    labelFolioLinkText:  'Link text in CV',
    placeholderFolioLinkText: 'e.g. My Portfolio',
    folioLinkTextHint:   'This text appears as a clickable link in your CV (e.g. "GitHub Projects", "My Designs").',
    labelFolioDisplayAs: 'Show as',
    folioOptionLink:     '🔗 Clickable link',
    folioOptionQR:       '🔲 Embed QR code',
    folioQRPreviewLabel: 'QR Code Preview',
    btnRegenQR:          '🔄 Regenerate',
    btnDownloadFolioQR:  '⬇ PNG',
    labelFolioQRPos:     'QR code position in CV',
    folioPosLeft:        '⬅ Sidebar',
    folioPosOverlay:     '📌 Free on CV',
    folioOverlayHint:    'Position on the CV (in %):',
    folioOverlayDragHint:'💡 Drag the QR code directly in the preview.',
    cvFolio:             'Portfolio',
    cvFolioSection:      'Portfolio & Links',
    ...
    tplSidebarName:      'Sidebar',
    tplSingleName:       'Single Column',
    tplAtsName:          'ATS-Friendly',
    tplTimelineName:     'Timeline',
  ...
  ar: {
    ...
    tplSidebarName:      'الشريط الجانبي',
    tplSingleName:       'عمود واحد',
    tplAtsName:          'متوافق مع أنظمة التتبع',
    tplTimelineName:     'الخط الزمني',
